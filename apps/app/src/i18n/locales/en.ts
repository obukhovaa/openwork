...
export default {
  ...
  "identities.mattermost_desc": "Your worker connects to a self-hosted Mattermost instance. Users can DM the bot or @mention it in channels.",
  "identities.mattermost_intro": "Connect your Mattermost server to let team members interact with this worker via DMs and channel mentions.",
  "identities.mattermost_unavailable": "Mattermost identities unavailable.",
  "identities.connect_mattermost": "Connect Mattermost",
  "identities.server_url_label": "Server URL",
  "identities.access_token_label": "Access Token",
